...
- [ ] **Blueprint Evidence Panel** — `BlueprintReveal` 에 "이 계산의 근거" expandable panel 추가 (Plan 21 Phase E stub)
  - Mifflin-St Jeor 공식 표시 + 입력 변수 요약 (weight/height/age/sex/activity)
  - Persona 의 macro profile 출처 (`source_refs[].url` 인용)
  - USDA FoodData Central 인용 (식재료 영양소 노출 시)
  - Medical disclaimer (`.claude/rules/domain/content.md` Health Disclaimer 기준 문구)
  - 컴포넌트: `packages/ui-kit/src/components/BlueprintEvidencePanel/` (Plan 22+ 에서 설계)
