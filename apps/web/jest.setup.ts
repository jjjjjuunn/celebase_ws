...
// Test stub only — commerce-service is not deployed at runtime yet.
// When commerce-service is added to docker-compose, update to the actual port.
process.env['COMMERCE_SERVICE_URL'] = 'http://localhost:3004';
