...
describe('dailyLogService.listByRange', () => {
  it('returns data and hasNext from repository', async () => {
    ...
    const result = await listByRange(mockPool, 'user-1', '2026-04-01', '2026-04-30', undefined, 20, mockLog);
  ...
  it('passes cursor for pagination', async () => {
    ...
    const result = await listByRange(mockPool, 'user-1', '2026-04-01', '2026-04-30', '2026-04-12', 10, mockLog);
...
describe('dailyLogService.getSummary', () => {
  it('returns aggregated summary from repository', async () => {
    ...
    const result = await getSummary(mockPool, 'user-1', '2026-04-01', '2026-04-30', '7d', mockLog);
  ...
  it('handles empty period', async () => {
    ...
    const result = await getSummary(mockPool, 'user-1', '2026-01-01', '2026-01-31', '7d', mockLog);
