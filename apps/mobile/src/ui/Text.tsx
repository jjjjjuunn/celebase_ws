  ...
  const { variants, tones } = useMemo(() => {
    ...
    return {
      variants: StyleSheet.create({
        ...
        metricXl: { ...mono, fontSize: theme.type.metricXl, fontWeight: theme.weight.semibold, lineHeight: Math.round(theme.type.metricXl * 1.12), letterSpacing: -0.5 },
        metricLg: { ...mono, fontSize: theme.type.metricLg, fontWeight: theme.weight.semibold, lineHeight: Math.round(theme.type.metricLg * 1.12), letterSpacing: -0.3 },
